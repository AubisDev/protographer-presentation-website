...
export const Home = () => {
    ...
    return (
        <div className='h-full w-screen flex flex-col xl:flex-row z-50 bg-gray-800 	'>
            <div className='w-full xl:w-1/5 h-10ph xl:h-screen flex flex-col items-center bg-gray-800  '>
                <Navbar  
                    setMenuActual={ setMenuActual } 
                    setPictures={setPictures} 
                    openResposiveMenu={  openResposiveMenu } 
                    setOpenResposiveMenu={setOpenResposiveMenu} 
                />
            </div>
