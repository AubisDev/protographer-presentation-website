...
import persona5 from '../img/persona-5.jpg'
...
export const getPersonImages = () => { return [ [persona1, persona2, persona3, persona4], [persona5,  random1,random2, random3 ], [random4, random5, paisaje1, paisaje2 ], [paisaje3, paisaje4, paisaje5, random2], [random3,random5,paisaje2,persona1] ] }
...
export const getEventImages = () => { return [ [evento1, evento2, evento3, evento4 ],[ evento5, persona1, persona2, persona3 ], [persona4, persona5, paisaje1, paisaje2 ], [paisaje3, paisaje4, paisaje5, random5],[persona3,evento1,persona4,wedding1,random1] ]}