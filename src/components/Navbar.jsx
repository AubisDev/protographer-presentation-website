            ...
            <div className='w-full h-full flex flex-row lg:flex-col justify-between sm:justify-evenly items-center  '>
               {
                   ...
                   (
                       <>
                        <button 
                            className='tracking-wide font-semibold h-full lg:h-auto animate__animated animate__fadeInDown animate__slower flex lg:flex-col flex-row  lg:-mt-10 md:mt-6 lg:mb-10'
                            onClick={() => setMenuActual('')}
                        >
                            <p className='text-2xl sm:text-4xl lg:text-4xl md:-mt-1 lg:w-full lg:flex font-tmodel2 text-white  text-center items-center justify-center h-full lg:h-auto relative top-1/2 transform -translate-y-1/4 '> Manuel </p>
                            <div className='sm:h-2/5 w-1 sm:mx-3 lg:mx-0 lg:h-1 lg:w-full -mb-4 bg-green-600 lg:my-2 lg:mt-2  sm:-mt-1 relative top-1/2 transform -translate-y-1/4  '/>
                            <p className='text-2xl sm:text-4xl lg:text-4xl lg:mt-3 md:-mt-1 w-full flex font-tmodel2 text-white text-center justify-center h-full relative top-1/2 transform -translate-y-1/4 ' > Alegría </p>
                            {
                        ...
                        <button 
                            ...
                            className = { menuClass }
                        >
                            <i className="fas fa-bars text-3xl text-white lg:mt-6 mt-1 py-2"></i>
                        </button>
                       </>
                   )
               }

                {
                    ...
                    (
                        ...
                        <button 
                            className='tracking-wide font-semibold h-full lg:h-auto animate__animated animate__fadeInDown animate__slower flex lg:flex-col flex-row mt-1'
                            onClick={() => setMenuActual('')}
                        >
                            <p className='text-3xl sm:text-4xl lg:text-5xl  lg:w-full lg:flex -mt-2 font-tmodel2 text-white  text-center items-center justify-center h-full lg:h-auto relative top-1/2 transform -translate-y-1/4  '> Manuel </p>
                            <div className='h-2/5 w-1 mx-3 lg:mx-0 lg:h-1 lg:w-full bg-green-600  lg:my-2 lg:mt-2 -mt-2 relative top-1/2 transform -translate-y-1/4  '/>
                            <p className='text-3xl sm:text-4xl lg:text-5xl lg:mt-3  w-full flex font-tmodel2 text-white text-center justify-center h-full relative top-1/2 transform -translate-y-1/4 -mt-2 ' > Alegría </p>
                            {
